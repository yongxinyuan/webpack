								...
								if (withWarning) {
									parser.state.module.addWarning(
										new NodeStuffInWebError(
											dep.loc,
											"global",
											"The global namespace object is Node.js feature and doesn't presented in browser."
										)
									);
								}
							});
						...
						switch (localOptions.__filename) {
							...
							case "warn-mock":
								setConstant(
									"__filename",
									"/index.js",
									"The __filename is Node.js feature and doesn't presented in browser."
								);
								break;
							case true:
						...
						switch (localOptions.__dirname) {
							...
							case "warn-mock":
								setConstant(
									"__dirname",
									"/",
									"The __dirname is Node.js feature and doesn't presented in browser."
								);
								break;
							case true:
