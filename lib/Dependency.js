...
class Dependency {
	constructor() {
		...
		this._locSL = 0;                 // start line 
		this._locSC = 0;                 // start column
		this._locEL = 0;                 // end line
		this._locEC = 0;                 // end column
		this._locI = undefined;          // index
		this._locN = undefined;          // name
		this._loc = undefined;           // location object
	}
